...
class Encoder_36M(torch.nn.Module):
  def __init__(self, height, width, latent_features):
    ...
    self.stage1 = torch.nn.Sequential(
      MBConvBlock(3, 48),
      torch.nn.Conv2d(48, 48, kernel_size=4, stride=2, padding=1),
      torch.nn.InstanceNorm2d(48, affine=True),
      torch.nn.PReLU()
    )
    ...
    self.stage2 = torch.nn.Sequential(
      MBConvBlock(48, 96),
      torch.nn.Conv2d(96, 96, kernel_size=4, stride=2, padding=1),
      torch.nn.InstanceNorm2d(96, affine=True),
      torch.nn.PReLU()
    )
    ...
    self.stage3 = torch.nn.Sequential(
      MBConvBlock(96, 192),
      torch.nn.Conv2d(192, 192, kernel_size=4, stride=2, padding=1),
      torch.nn.InstanceNorm2d(192, affine=True),
      torch.nn.PReLU()
    )
    ...
    self.stage4 = torch.nn.Sequential(
      MBConvBlock(192, 288),
      torch.nn.Conv2d(288, 288, kernel_size=4, stride=2, padding=1),
      torch.nn.InstanceNorm2d(288, affine=True),
      torch.nn.PReLU()
    )
    ...
    self.fc_lam = torch.nn.Sequential(
      torch.nn.Linear(n * 288, latent_features),
